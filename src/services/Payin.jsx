      ...
      >
              ...
              {/* <div className="flex flex-wrap gap-2 mt-2">
                {[500, 1000, 2000, 5000, 10000].map((val) => (
                  <button
                    key={val}
                    type="button"
                    onClick={() => formik.setFieldValue("amount", String(val))}
                    // className={`px-4 py-1 rounded-full border text-sm font-medium ${
                    //   formik.values.amount === String(val)
        ...
        ${
          formik.values.amount === String(val)
            ...
            : "bg-[#4c5169] text-white border-transparent"
        }
      `}
                  >
                    {val}
            ...
            {/* <div>
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  formik.setFieldValue("utr_no", onlyDigits);
                }}
                onBlur={formik.handleBlur}
