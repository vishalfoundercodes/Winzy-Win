...
// import usawinlogo from "../assets/2-removebg.png";
  ...
  return (
    <>
      <header className="flex items-center bg-blackAviator2 text-blackAviatorText justify-between h-[3.22rem] w-full px-3">
        ...
        <img
          className="w-16 h-12 object-fill cursor-pointer "
          src={usawinlogo}
          alt="Logo"
          onClick={() => navigate("/")}
        />
        <div className="flex items-center gap-2 text-xsm relative">
          ...
          {isOpen && (
            <motion.div
              ...
              className="absolute pointer-events-auto top-8 z-[60] right-0 text-white w-[310px] border-gray border-[1px] bg-[#1B1C1D] shadow-lg rounded-lg "
            >
