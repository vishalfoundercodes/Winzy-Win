...
function AviatorFlight({ changeBg, setChangeBg, isSoundOn, setIsSoundOn, isPathRemoved, setIsPathRemoved }) {
    ...
    return (
      ...
      >
        {isModalOpen && (
          <div className="absolute top-[30%] -left-5 xs2:left-[30%] xl:left-[40%] z-40 p-6 w-96 flex flex-col items-center justify-center">
            {hotAirData?.status == 2 ? (
              <div
                className={`sm:-ml-28 [text-shadow:_0_4px_8px_rgb(99_102_241_/_0.8)] 
                           text-white leading-snug 
                           font-manrope font-extrabold w-full text-${
              ...
              >
                Flew away! <br />
                <span
                  className={`[text-shadow:_0_4px_8px_rgb(99_102_241_/_0.8)] leading-snug 
                           font-manrope w-full font-extrabold text-[#F85050] text-${
                             changeBg?.image === "3" || changeBg?.image === "5"
                               ? "yellow"
                               : "white"
              ...
              <div className="flex flex-col -mt-32 sm:-ml-28 xsm:pl-0 items-center justify-center h-full">
                <img
                  src={fan_aviator}
                  className="w-48 h-48 xsm:w-64 xsm:h-64"
                  alt="Logo"
                />
                <p
                  className={`[text-shadow:_0_4px_8px_rgb(99_102_241_/_0.8)] 
                           text-white leading-snug 
                           font-manrope font-extrabold  text-${
                             changeBg?.image === "3" || changeBg?.image === "5"
                               ? "yellow"
                               : "white"
                           } -mt-12 text-nowrap font-bold text-center text-[1.5rem] sm:text-[3rem] w-full `}
                >
        ...
        >
          <Layer>
            ...
            {!isPathRemoved && (
              <Line points={linePoints} stroke="#DE003D" strokeWidth={5} />
            )}
          </Layer>
        </Stage>
        ...
        >
          <img
            src={aviator}
            className="w-24 h-12 -ml-2 md:w-48 md:h-20"
            alt="aviator"
          />
        </div>
        ...
        {changeBg?.image === "1" ? (
          ...
          <div
            ...
            style={{
              ...
              animation:
                hotAirData?.status === 1 ? "spin 15s linear infinite" : "none",
            }}
          ></div>
        )}
      </div>
